...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public class EntityTypePathComparer : IComparer<IEntityType>
    {
        ...
        public virtual int Compare(IEntityType x, IEntityType y)
        {
            ...
            while (true)
            {
                var xDefiningNavigationName = x.FindDefiningNavigationName();
                var yDefiningNavigationName = y.FindDefiningNavigationName();
                ...
                x = x.FindDefiningEntityType();
                y = y.FindDefiningEntityType();
            }
        }
        ...
        public virtual int GetHashCode([NotNull] IEntityType entityType)
        {
            ...
            while (true)
            {
                ...
                var definingNavigationName = entityType.FindDefiningNavigationName();
                ...
                entityType = entityType.FindDefiningEntityType();
            }
        }
    }
}