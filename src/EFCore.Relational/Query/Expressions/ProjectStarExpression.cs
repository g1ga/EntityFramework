...
namespace Microsoft.EntityFrameworkCore.Query.Expressions
{
    ...
    public class ProjectStarExpression : Expression
    {
        ...
        public ProjectStarExpression([NotNull]List<Expression> projections,
        ...
        public virtual Expression GetOrAdd(Expression expression)
        {
            var projectionIndex = _projections.FindIndex(e => SelectExpression.ExpressionEqualityComparer.Equals(e, expression));

            if (projectionIndex != -1)
            {
                return _projections[projectionIndex];
            }
